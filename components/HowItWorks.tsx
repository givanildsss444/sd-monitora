export default function HowItWorks(){
    ...
    return(
        ...
        <section id="how-it-works" className="w-full bg-[#E2F7FF] from-[#E2F7FF] to-white bg-gradient-to-bl py-12 md:py-24 lg:py-32">
                    ...
                    <div className="container mx-auto flex flex-col items-center px-4 md:px-6">
                      ...
                      <div className="mx-auto pt-12">    
                        ...
                        <div className="grid grid-cols-[1fr_auto_1fr] gap-4">
                            ...
                            <div className="relative after:absolute after:bottom-0 after:start-7 after:top-14 after:-translate-x-[0.5px] after:border-l-2 after:border-dashed after:border-[#40CDFB]/50 last:after:hidden md:after:start-8 md:after:top-16">
                            ...
                            <div className="mb-6 flex-1 space-y-3 rounded-lg bg-white bg-gradient-to-r from-white to-transparent p-4 text-left">
                        ...
                        <div className="grid grid-cols-[1fr_auto_1fr] max-md:grid-cols-[auto_1fr] gap-x-1 ">

                          
                            <div className="order-1 max-md:order-2 mb-6 flex-1 space-y-3 rounded-lg bg-white bg-gradient-to-r from-white to-transparent p-4 text-right max-md:text-left">
                            ...
                            <div className="order-2 max-md:order-1 relative after:absolute after:bottom-0 after:start-7 after:top-14 after:-translate-x-[0.5px] after:border-l-2 after:border-dashed after:border-[#40CDFB]/50 last:after:hidden md:after:start-8 md:after:top-16">
                                <div className="relative z-10 flex size-14 items-center justify-center md:size-16">
                        ...
                        <div className="grid grid-cols-[1fr_auto_1fr] gap-4">
                            ...
                            <div className="relative after:absolute after:bottom-0 after:start-7 after:top-14 after:-translate-x-[0.5px] after:border-l-2 after:border-dashed after:border-[#40CDFB]/50 last:after:hidden md:after:start-8 md:after:top-16">
                                <div className="relative z-10 flex size-14 items-center justify-center md:size-16">
                                <div className="relative z-10 flex size-8 items-center justify-center rounded-full bg-[#40CDFB] text-lg font-semibold text-white md:size-10 md:text-xl">3</div>
                                </div>
                            </div>
            
                            <div className="mb-6 flex-1 space-y-3 rounded-lg bg-white bg-gradient-to-r from-white to-transparent p-4 text-left">
                                <h3 className="text-xl text-black font-semibold">Acompanhamento motivacional com mensagens de voz</h3>
                                <p className="text-black">Grave áudios semanais com base no painel e envie para os pacientes com orientações, elogios e reforços positivos.</p>
                                <p className="italic text-black">O toque humano que aproxima, sem consumir seu tempo.</p>
                            </div>
                        ...
                        <div className="grid grid-cols-[1fr_auto_1fr] max-md:grid-cols-[auto_1fr] gap-x-1 ">
                            ...
                            <div className="order-1 max-md:order-2 mb-6 flex-1 space-y-3 rounded-lg bg-white bg-gradient-to-r from-white to-transparent p-4 text-right max-md:text-left">
                                <h3 className="text-xl text-black font-semibold">Relatórios prontos com evolução e engajamento</h3>
                                <p className="text-black">Veja quem está engajado, quem precisa de atenção e como está a evolução de peso.</p>
                                <p className="italic text-black">Use os dados para ajustar condutas e mostrar resultado nas consultas.</p>
                            </div>
            
                            <div className="order-2 max-md:order-1 relative ">
                                <div className="relative z-10 flex size-14 items-center justify-center md:size-16">
                                    <div className="relative z-10 flex size-8 items-center justify-center rounded-full bg-[#40CDFB] text-lg font-semibold text-white md:size-10 md:text-xl">4</div>
                                </div>
                            </div>
