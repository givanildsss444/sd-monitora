          ...
          <section className="relative w-full overflow-hidden bg-[#FFFFFF] py-12 md:py-24 lg:py-32">
            ...
            <div className="container relative z-10 mx-auto px-4 md:px-6">
              ...
              <div className="mx-auto grid gap-8 pt-12 md:gap-8 lg:mt-6 lg:grid-cols-3">
                ...
                <div className="gap-4 rounded-xl border bg-card py-4 text-card-foreground md:gap-6 md:py-6 flex h-full flex-col shadow-md transition-shadow hover:shadow-lg sm:max-w-none">
                  <div className="has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-4 md:[.border-b]:pb-6 grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 px-4 md:px-6">
                    <div className="text-xl font-semibold">Plano Básico</div>
                    <div className="text-4xl font-bold">
                      "R$"
                      "59"
                      <span className="text-base font-normal text-foreground/80">/ paciente / mês</span>
                    </div>
                  ...
                  <div className="px-4 md:px-6 flex-1">
                    ...
                    <ul className="my-6 space-y-3">
                      <li className="flex gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check-big mt-0.5 h-5 w-5 flex-shrink-0 text-primary"><path d="M21.801 10A10 10 0 1 1 17 3.335"></path><path d="m9 11 3 3L22 4"></path></svg>
