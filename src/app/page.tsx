              ...
              <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-16 lg:grid-cols-2">
                <div>
                  <div className="space-y-2 text-center lg:text-left">
                    <div className="inline-block rounded-lg bg-background/70 px-3 py-1 text-sm font-semibold text-primary">Contato</div>
                    ...
                    <p className="max-w-3xl text-foreground/80 md:text-xl/relaxed">Preencha o formulário abaixo para falar com um especialista do nosso time.</p>
                    <p className="max-w-3xl text-foreground/80 md:text-xl/relaxed">Vamos entender sua realidade e te mostrar como o SD Monitora pode se integrar ao seu plano de forma simples, eficiente e lucrativa.</p>
                  </div>
